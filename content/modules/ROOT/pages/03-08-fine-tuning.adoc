...
Before we proceed with fine-tuning the model, let's try chatting with a model that has not been fine-tuned yet.

* Open the https://rhods-dashboard-redhat-ods-applications.{openshift_cluster_ingress_domain}/[{rhoai} Dashboard application,window=_blank] in a new window or tab and navigate to the Data Science Projects menu on the left:
+
[.bordershadow]
image::02/02-02-ds-proj-nav.png[]

* Open the project called {user} and click the `Create workbench` button:
+
[.bordershadow]
...
[source,bash,subs="+attributes,macros+"]
----
ilab model chat --endpoint-url {unfinetuned-endpoint}
----
...
=== TODO: Fix qna.yaml - it has trailing spaces
...
INFO 2024-10-02 16:47:28,764 instructlab.sdg.eval_data:126: Saving MMLU Dataset /opt/app-root/src/.local/share/instructlab/datasets/node_datasets_2024-10-02T16_21_57/mmlubench_knowledge_economy_finance_insurance_parasol.jsonl
Creating json from Arrow format: 100%|█████████████████████████████████| 1/1 [00:00<00:00, 567.10ba/s]
INFO 2024-10-02 16:47:28,780 instructlab.sdg.eval_data:130: Saving MMLU Task yaml /opt/app-root/src/.local/share/instructlab/datasets/node_datasets_2024-10-02T16_21_57/knowledge_economy_finance_insurance_parasol_task.yaml
...
-rw-r--r--   1 ltsai  staff       360 21 Oct 21:10 knowledge_recipe_2024-10-21T07_26_32.yaml
-rw-r--r--   1 ltsai  staff  41713091 21 Oct 21:10 knowledge_train_msgs_2024-10-21T07_26_32.jsonl
-rw-r--r--   1 ltsai  staff   2945140 21 Oct 21:10 messages_mistral-7b-instruct-v0.2.Q4_K_M_2024-10-21T07_26_32.jsonl
drwxr-xr-x   6 ltsai  staff       192 21 Oct 21:10 node_datasets_2024-10-21T07_26_32
-rw-r--r--   1 ltsai  staff       360 21 Oct 21:10 skills_recipe_2024-10-21T07_26_32.yaml
-rw-r--r--   1 ltsai  staff  99148070 21 Oct 21:10 skills_train_msgs_2024-10-21T07_26_32.jsonl
-rw-r--r--   1 ltsai  staff     19500 21 Oct 21:10 test_gen.jsonl
-rw-r--r--   1 ltsai  staff     19500 21 Oct 21:10 test_mistral-7b-instruct-v0.2.Q4_K_M_2024-10-21T07_26_32.jsonl
-rw-r--r--   1 ltsai  staff   2622841 21 Oct 21:10 train_gen.jsonl
-rw-r--r--   1 ltsai  staff   2622841 21 Oct 21:10 train_mistral-7b-instruct-v0.2.Q4_K_M_2024-10-21T07_26_32.jsonl
----
...
[source,console]
----
head ~/.local/share/instructlab/datasets/knowledge_train_msgs_2024-10-21T07_26_32.jsonl
<SHOW the FILE LIST>
----
...
[source,bash,subs="+attributes,macros+"]
----
ilab model chat --endpoint-url {finetuned-endpoint}
----
