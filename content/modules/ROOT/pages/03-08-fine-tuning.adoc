...
[source,bash,subs="+attributes,macros+"]
----
mkdir -p ~/taxonomy/knowledge/economy/finance/insurance/parasol
----
...
[source,bash,subs="+attributes,macros+"]
----
curl -Lo ~/taxonomy/knowledge/economy/finance/insurance/parasol/qna.yaml {qna-url}
----
...
[source,bash,subs="+attributes,macros+"]
----
curl -Lo ~/taxonomy/knowledge/economy/finance/insurance/parasol/attribution.txt {attribution-url}
----
...
=== TODO: Regenerate `config.yaml` because we need the model to point to mistral
...
* https://github.com/rhpds/showroom_instructlab_summit2024/blob/main/content/modules/ROOT/pages/index.adoc[Summit lab^]
