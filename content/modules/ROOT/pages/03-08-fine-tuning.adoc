...
image::03/rag-vs-finetuning-1.png[RAG vs Fine-Tuning]
...
image::03/rag-vs-finetuning-2.png[RAG vs Fine-Tuning]
...
image::03/instructlab-components.png[InstructLab Overview]
...
image::03/parasol-insurance-chat.png[Parasol Insurance]
...
image::03/instructlab-taxonomy.png[InstructLab Taxonomy]
